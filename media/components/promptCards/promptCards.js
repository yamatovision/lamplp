...
const promptUrls = [
  ...
  "http://bluelamp-235426778039.asia-northeast1.run.app/api/prompts/public/50eb4d1e924c9139ef685c2f39766589", // ★6インフラエンジニア
  "http://bluelamp-235426778039.asia-northeast1.run.app/api/prompts/public/b168dcd63cc12e15c2e57bce02caf704", // ★7バックエンドエンジニア
  "http://bluelamp-235426778039.asia-northeast1.run.app/api/prompts/public/5a3f08098fd5b7846602e9b5446b7d44", // ★8テスト品質エンジニア
  "http://bluelamp-235426778039.asia-northeast1.run.app/api/prompts/public/e6167ac13d15f778c0cae369b0068813", // ★9フロントエンドエンジニア
  "http://bluelamp-235426778039.asia-northeast1.run.app/api/prompts/public/942ec5f5b316b3fb11e2fd2b597bfb09", // ★10デバッグ探偵
  "http://bluelamp-235426778039.asia-northeast1.run.app/api/prompts/public/612fc1991ca477744c4544255d40fe0b", // ★11デプロイ
  "http://bluelamp-235426778039.asia-northeast1.run.app/api/prompts/public/868ba99fc6e40d643a02e0e02c5e980a", // ★12GitHub
  "http://bluelamp-235426778039.asia-northeast1.run.app/api/prompts/public/247df2890160a2fa8f6cc0f895413aed", // ★13型エラー解決
  "http://bluelamp-235426778039.asia-northeast1.run.app/api/prompts/public/8c09f971e4a3d020497eec099a53e0a6", // ★14機能追加
  "http://bluelamp-235426778039.asia-northeast1.run.app/api/prompts/public/af9d922c29beffe1224ac6236d083946"  // ★15リファクタリング
];
...
const promptInfo = [
  ...
  { id: 6, name: "バックエンド実装", icon: "database", category: "★7", description: "データベースからAPIエンドポイントの構築" },
  { id: 7, name: "テスト品質検証", icon: "verified", category: "★8", description: "単体・統合テストによる品質保証" },
  { id: 8, name: "フロントエンド実装", icon: "web", category: "★9", description: "UIコンポーネントとAPI連携の実装" },
  { id: 9, name: "デバッグ探偵", icon: "bug_report", category: "★10", description: "エラーの問題の特定と修正" },
  { id: 10, name: "デプロイ", icon: "cloud_upload", category: "★11", description: "クラウドサービスへの安定したデプロイ" },
  { id: 11, name: "GitHub", icon: "history", category: "★12", description: "Gitを活用した安全なコード管理" },
  { id: 12, name: "型エラー解決", icon: "rule", category: "★13", description: "TypeScript型整合性の確保と最適化" },
  { id: 13, name: "機能追加", icon: "add_circle", category: "★14", description: "新機能の設計と既存システムへの統合" },
